...
const cards = document.querySelectorAll('.kategori-card, .fotografer-card, .keunggulan-card, .testimoni-card, .artikel-card');
...
console.log('Total fotografer cards:', document.querySelectorAll('.fotografer-card').length);
console.log('Total kategori:', document.querySelectorAll('.kategori-card').length);